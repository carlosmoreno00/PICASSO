...
class FrontendPresetController extends Controller
{
    ...
    {
        $presets = DB::select("SELECT presets.id, presets.name, presets.price, presets.created_at, presets.photo, presets.iduser, users.name as username from users, presets where presets.iduser = users.id order by presets.id desc");
    ...
    public function mypresets() {
        $id = auth()->user()->id;
        $presets = DB::select("select presets.photo, presets.id as idpreset, presets.name, users.name as username, presets.created_at, presets.price from presets, users where presets.iduser = $id and users.id = $id order by presets.created_at desc");
