        ...
        <section class="section-single">
            ...
            <div class="container container-single" >
                <div class="row row-single" >
                    <div class="col-12">
                      <h1> <b>PICASSO</b>  — <?php echo e($photo->user->nickname); ?></h1>
                    </div>
                    <div class="col-12 col-createphoto">
                       <div class="form-createphoto">
                           <form role="form" action="<?php echo e(url('/home/photos/' . $photo->id . '/edit')); ?>" method="post" id="editPhotoForm" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                              <?php echo method_field('put'); ?>
                               <h1>Edit Photo</h1>
                                 
                                 <div class="center-img-file">
                                       <img id="output" src="data:image/png;base64,<?php echo e($photo->photo); ?>"></img> 
                                 </div>
                               ...
                               <select class="custom-select w-100" name="idpreset" id="idpreset" required="">
                                   <option value="" disabled>Select preset</option>
                                        ...
                                        <option selected value="<?php echo e($preset->idpreset); ?>"><?php echo e($preset->name); ?></option>
                                        <?php else: ?>
                                ...
                                <input id="camera" type="text" class="form-control " name="camera" value="<?php echo e(old('camera', $photo->camera)); ?>" required="" >
                                <div class="divider-form">
                                    <div>
                                       ...
                                       <input id="lens" type="text" class="form-control " name="lens" value="<?php echo e(old('lens', $photo->lens)); ?>" required="" >
                                   </div>
                                   <div>
                                       ...
                                       <input id="shutter_speed" type="text" class="form-control " name="shutter_speed" value="<?php echo e(old('shutter_speed', $photo->shutter_speed)); ?>" required="" >
                                   </div>
                                </div>
                                 ...
                                 <div class="divider-form">
                                    <div>
                                       ...
                                       <input id="iso" type="text" class="form-control " name="iso" value="<?php echo e(old('iso', $photo->iso)); ?>" required="" >
                                   </div>
                                   <div>
                                       ...
                                       <input id="focal" type="text" class="form-control " name="focal" value="<?php echo e(old('focal', $photo->focal)); ?>" required="" >
                                   </div>
                                </div>
...
<?php /**PATH C:\xampp\htdocs\proyectofinal\resources\views/frontend/photo/editphoto.blade.php ENDPATH**/ ?>