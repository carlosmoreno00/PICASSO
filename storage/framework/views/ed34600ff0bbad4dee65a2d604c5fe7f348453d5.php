        ...
        <section class="section-single">
            ...
            <div class="container container-single" >
                <div class="row row-single" >
                    <div class="col-12">
                      <h1> <b>PICASSO</b>  — <?php echo e($preset->user->nickname); ?></h1>
                    </div>
                    <div class="col-12 col-createphoto">
                       <div class="form-createphoto">
                           <form role="form" action="<?php echo e(url('/home/presets/' . $preset->id . '/edit')); ?>" method="post" id="editPresetForm" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                              <?php echo method_field('put'); ?>
                               <h1>Edit Preset</h1>
                                 
                                 <div class="center-img-file">
                                      <img id="output" src="data:image/png;base64,<?php echo e($preset->photo); ?>"></img> 
                                 </div>
                                ...
                                <input id="name" type="text" class="form-control " name="name" value="<?php echo e(old('name', $preset->name)); ?>" required="" autocomplete="name" autofocus="">
                                
                                <label for="description">Description</label>
                                <textarea name="description" ><?php echo e(old('description', $preset->description)); ?></textarea>
                                <label for="price">Price €</label>
                                <input type="number" min="0" max="9999.99" step="0.01" required="" class="form-control" id="price" name="price" value="<?php echo e(old('price', $preset->price)); ?>">
...
<?php /**PATH C:\xampp\htdocs\proyectofinal\resources\views/frontend/preset/editpreset.blade.php ENDPATH**/ ?>