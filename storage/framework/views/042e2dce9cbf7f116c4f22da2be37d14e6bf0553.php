                ...
                <div class="row row-single" >
                    ...
                    <div class="col-12 col-createphoto">
                       <div class="form-createphoto">
                           <form role="form" action="<?php echo e(url('mypresets/create')); ?>" method="post" id="createPresetForm" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                               <h1>Add Preset</h1>
                                ...
                                <input id="name" type="text" class="form-control " placeholder="Preset name" name="name" value="<?php echo e(old('name')); ?>" required="" autocomplete="name" autofocus="">
                                
                                <label for="description">Description</label>
                                <textarea name="description" id="description" placeholder="Preset description"><?php echo e(old('description')); ?></textarea>
                                <label for="price">Price €</label>
                                <input type="number" min="0" max="9999.99" step="0.01" required="" class="form-control" id="price" placeholder="Preset price" name="price" value="<?php echo e(old('price')); ?>">
...
<?php /**PATH C:\xampp\htdocs\proyectofinal\resources\views/frontend/preset/createpreset.blade.php ENDPATH**/ ?>