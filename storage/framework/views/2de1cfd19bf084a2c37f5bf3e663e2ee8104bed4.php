                ...
                <div class="row row-single" >
                    ...
                    <div class="col-8 col-cart">
                       ...
                       <div class="article-cart">
                           <p class="p-start"><a href="<?php echo e(url('/preset')); ?>">X</a></p>
                           <div class="img-cart"><img src="data:image/png;base64,<?php echo e($preset->photo); ?>"></img></div>
                           <p>$ <?php echo e($preset->price); ?></p>
                           <p class="p-end">$ <?php echo e($preset->price); ?></p>
                    ...
                    <div class="col-4">
                        <div class="features">
                            ...
                            <form role="form" action="<?php echo e(url('buy/' . $preset->id)); ?>" method="post" id="createPurchaseForm" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <input type="text" maxlength="1000" minlength="1" required class="form-control" id="iduser" placeholder="iduser" name="iduser" value="<?php echo e(Auth::user()->id); ?>" style="display:none">
                                <input type="text" maxlength="1000" minlength="1" required class="form-control" id="idpreset" placeholder="idpreset" name="idpreset" value="<?php echo e($preset->id); ?>" style="display:none">
...
<?php /**PATH C:\xampp\htdocs\proyectofinal\resources\views/frontend/purchase/cart.blade.php ENDPATH**/ ?>