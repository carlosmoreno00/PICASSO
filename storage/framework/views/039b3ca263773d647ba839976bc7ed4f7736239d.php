        ...
        <section class="section-single">
            ...
            <div class="container container-single" >
                <div class="row row-single" >
                    <div class="col-12">
                      <h1> <b>PICASSO</b>  — For <?php echo e($photo->user->name); ?></h1>
                    </div>
                    <div class="col-7">
                        <div class="single-feed">
                            <div class="item">
                                <p><?php echo e($photo->created_at); ?></p>
                                <a data-fancybox="gallery" href="data:image/png;base64,<?php echo e($photo->photo); ?>"><img src="data:image/png;base64,<?php echo e($photo->photo); ?>"></a>
                                  <style type="text/css">
                                      .style-a-likes:hover{
                                   ...
                                   <?php if( $photolikes != null ): ?>
                                 	...
                                 	<?php else: ?>
        							     ...
        							     <form role="form" action="<?php echo e(url('/home/photos/like')); ?>" method="post" id="createLikeForm" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                                    ...
                                                    <select style="display:none" name="idphoto" id="idphoto" required class="form-control">
                                                        <option value="<?php echo e($photo->id); ?>" selected><?php echo e($photo->id); ?></option>
                                                    </select>
                                                <button type="submit" style="border: none; background: transparent;" class="favorite"><svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="heart" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-heart fa-w-16 fa-9x"><path fill="currentColor" d="M458.4 64.3C400.6 15.7 311.3 23 256 79.3 200.7 23 111.4 15.6 53.6 64.3-21.6 127.6-10.6 230.8 43 285.5l175.4 178.7c10 10.2 23.4 15.9 37.6 15.9 14.3 0 27.6-5.6 37.6-15.8L469 285.6c53.5-54.7 64.7-157.9-10.6-221.3zm-23.6 187.5L259.4 430.5c-2.4 2.4-4.4 2.4-6.8 0L77.2 251.8c-36.5-37.2-43.9-107.6 7.3-150.7 38.9-32.7 98.9-27.8 136.5 10.5l35 35.7 35-35.7c37.8-38.5 97.8-43.2 136.5-10.6 51.1 43.1 43.5 113.9 7.3 150.8z" class=""></path></svg> </button><?php echo e($likesall[0]->likesall); ?> likes
                    ...
                    <div class="col-5">
                        <div class="features">
                            <h2>Features</h2>
                            <div class="carct"><h3>Camera</h3> <h4><?php echo e($photo->camera); ?></h4></div>
                            <div class="carct"><h3>Lens</h3> <h4><?php echo e($photo->lens); ?></h4></div>
                            <div class="carct"><h3>Shutter Speed</h3> <h4><?php echo e($photo->shutter_speed); ?></h4></div>
                            <div class="carct"><h3>ISO</h3> <h4><?php echo e($photo->iso); ?></h4></div>
                            <div class="carct"><h3>Focal</h3> <h4><?php echo e($photo->focal); ?></h4></div>
                            <div class="carct carctend"><h3>Preset</h3> <h4><?php echo e($photo->preset->name); ?></h4></div>
                            <?php if($photo->iduser == Auth::user()->id): ?>
                            <div class="edit-a"><a class="delete-feature" href="<?php echo e(url('/home/photos/' . $photo->id . '/delete')); ?>">Delete</a><a href="<?php echo e(url('/home/photos/' . $photo->id . '/edit')); ?>">Edit Photo</a></div>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div class="container container-form" >
                <div class="row row-form" >
                    <div class="col-12 col-form">
                        ...
                        <form role="form" action="<?php echo e(url('comment/'. $photo->id)); ?>" method="post" id="createCommentForm" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            ...
                            <input type="text" maxlength="1000" minlength="1" required class="form-control" id="idphoto" placeholder="Photo" name="idphoto" value="<?php echo e($photo->id); ?>" style="display:none">
                          <textarea placeholder="Comment" id="description" name="description" ><?php echo e(old('description')); ?></textarea>
...
<?php /**PATH C:\xampp\htdocs\proyectofinal\resources\views/frontend/photo/singlephoto.blade.php ENDPATH**/ ?>