  ...
  <body id="preset-picart">
      ...
      <div class="nav-home">
            ...
            <ul>
                ...
                <li> <a href="<?php echo e(url('/preset')); ?>"><b>Presets</b></a> </li>
                ...
                <div class="row row-preset" >
                    ...
                    <div class="col-12">
                        <div class="gallery-preset">
                            ...
                            <div class="item">
                                <div class="buy-preset"><a href="<?php echo e(url('home/presets/' . $preset->id)); ?>">View and buy</a></div>
                                <div class="preset-date">
                                    <h5><?php echo e(date('d-m-y', strtotime($preset->created_at))); ?></h5>
                                </div>

                                <img src="data:image/png;base64,<?php echo e($preset->photo); ?>"></img> 
                                <div class="user-see">
                                    <h5><?php echo e($preset->username); ?></h5>
                                    <h4><?php echo e($preset->name); ?></h4>
                                    <h3>$<?php echo e($preset->price); ?></h3>
                                </div>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\proyectofinal\resources\views/frontend/preset/presets.blade.php ENDPATH**/ ?>