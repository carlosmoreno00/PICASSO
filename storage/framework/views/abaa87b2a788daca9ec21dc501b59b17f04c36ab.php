                ...
                <div class="row row-single" >
                    ...
                    <div class="col-12 col-createphoto">
                       <div class="form-createphoto">
                           <form role="form" action="<?php echo e(url('/mypresets/preset/updatecreate/' . $preset->id)); ?>" method="post" id="createPresetForm" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                              <?php echo method_field('put'); ?>
                               <h1>Add Preset</h1>
                                 ...
                                 <!--     <img id="output" src="<?php echo e(url('/assets/frontend/images/preset4.jpg')); ?>"></img> -->
                                 <!--</div>-->
                                 ...
                                 <!--</div>-->
                                  <label for="email">Archive ( .ZIP  )</label>
...
<?php /**PATH C:\xampp\htdocs\proyectofinal\resources\views/frontend/preset/editcreatepreset.blade.php ENDPATH**/ ?>