        ...
        <section class="section-preset">
            ...
            <div class="container container-preset" >
                <div class="row row-preset" >
                    <div class="col-12">
                      <h1> <b>PICASSO</b>  — My Presets</h1>
                    </div>
                    <div class="col-12 col-createpreset">
                        <a href="<?php echo e(url('/mypresets/create')); ?>" class="createpreset">Add Preset</a>
                    </div>
                    <div class="col-12 content-mypresets">
                        <div class="gallery-preset">
                            ...
                            <div class="item">
                                ...
                                <a href="<?php echo e(url('home/presets/' . $preset->idpreset  )); ?>"><img src="data:image/png;base64,<?php echo e($preset->photo); ?>"></img> </a>
                                <div class="user-see">
                                    <h5><?php echo e($preset->name); ?></h5>
...
<?php /**PATH C:\xampp\htdocs\proyectofinal\resources\views/frontend/preset/mypresets.blade.php ENDPATH**/ ?>