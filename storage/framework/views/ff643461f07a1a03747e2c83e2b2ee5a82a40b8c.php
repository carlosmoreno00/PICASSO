        ...
        <section class="section-preset">
            ...
            <div class="container container-preset" >
                <div class="row row-preset" >
                    <div class="col-12">
                      <h1> <b>PICASSO</b>  — My Saved Presets</h1>
                    </div>
                        ...
                        <div class="gallery-preset">
                            ...
                            <div class="item">
                                <div class="preset-date">
                                    <h5><?php echo e(date('d-m-y', strtotime($favourite->created_at))); ?></h5>
                                </div>
                                <a href="<?php echo e(url('home/presets/' . $favourite->idpreset  )); ?>"><img src="data:image/png;base64,<?php echo e($favourite->presetphoto); ?>"></img> </a>
                                <div class="user-see">
                                    <h5><?php echo e($favourite->pname); ?></h5>
                                    <h3><?php echo e($favourite->price); ?> $</h3>
                                </div>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\proyectofinal\resources\views/frontend/favourite/savedpresets.blade.php ENDPATH**/ ?>