  ...
  <body id="feed-picart">
         ...
         <div class="nav-home">
            ...
            <ul>
                ...
                <li> <a href="<?php echo e(url('/feed')); ?>"><b>Feed</b></a> </li>
        ...
        <section class="section-gallery">
            ...
            <div class="container container-gallery" >
                <div class="row row-gallery" >
                    <div class="col-12">
                      <h1> <b>PICASSO</b>  — For creators, by creators</h1>
                    </div>
                    <div class="col-12">
                        <div class="gallery-feed">
                            ...
                            <div class="item">
                                <a href="<?php echo e(url('home/photos/' . $photo->id  )); ?>">
                                <img src="data:image/png;base64,<?php echo e($photo->photo); ?>"></img> 
                                </a>
                                <div class="user-see">
                                    <h5><?php echo e($photo->name); ?></h5>
                                    <a data-fancybox="gallery" href="data:image/png;base64,<?php echo e($photo->photo); ?>">
...
<?php /**PATH C:\xampp\htdocs\proyectofinal\resources\views/frontend/photo/feed.blade.php ENDPATH**/ ?>