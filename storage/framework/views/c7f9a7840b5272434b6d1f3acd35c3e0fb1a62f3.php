        ...
        <section class="section-single">
            ...
            <div class="container container-single" >
                <div class="row row-single" >
                    <div class="col-12">
                      <h1> <b>PICASSO</b>  — <?php echo e(Auth::user()->nickname); ?></h1>
                    </div>
                    <div class="col-12 col-createphoto">
                       <div class="form-createphoto">
                           <form role="form" action="<?php echo e(url('/myphotos/create')); ?>" method="post" id="createPhotoForm" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                               <h1>Add Photo</h1>
                                 
                                 <div style="display:none">
                                    <label for="iduser">User</label>
                                    <input type="text" value="<?php echo e(Auth::user()->id); ?>" readonly class="form-control">
                                    <input type="hidden" id="iduser" name="iduser" value="<?php echo e(Auth::user()->id); ?>">
                                 </div>
                                ...
                                <input id="camera" type="text" class="form-control " placeholder="Camera" name="camera" value="<?php echo e(old('camera')); ?>" required="" autocomplete="name" autofocus="">
                                <div class="divider-form">
                                    <div>
                                       ...
                                       <input id="lens" type="text" class="form-control " name="lens" value="<?php echo e(old('lens')); ?>" required="" placeholder="Lens" autocomplete="name" autofocus="">
                                   </div>
                                   <div>
                                       ...
                                       <input id="shutter_speed" type="text" class="form-control " name="shutter_speed" value="<?php echo e(old('shutter_speed')); ?>" required="" placeholder="Shutter Speed" autocomplete="email" autofocus="">
                                   </div>
                                </div>
                                 ...
                                 <div class="divider-form">
                                    <div>
                                       ...
                                       <input id="iso" type="text" class="form-control " name="iso" value="<?php echo e(old('iso')); ?>" required="" placeholder="ISO" autocomplete="name" autofocus="">
                                   </div>
                                   <div>
                                       ...
                                       <input id="focal" type="text" class="form-control " name="focal" value="<?php echo e(old('focal')); ?>" required="" placeholder="Focal" autocomplete="email" autofocus="">
                                   </div>
                                </div>
...
</html><?php /**PATH C:\xampp\htdocs\proyectofinal\resources\views/frontend/photo/createphoto.blade.php ENDPATH**/ ?>