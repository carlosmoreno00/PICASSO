        ...
        <section class="section-account">
            ...
            <div class="container container-single" >
                <div class="row row-single" >
                    <div class="col-12">
                      <h1> <b>PICASSO</b>  — My Account</h1>
                    </div>
                    <div class="col-6 col-account">
                         <div class="account-container">
                            
                            <?php $__errorArgs = ['usererror'];
...
unset($__errorArgs, $__bag); ?>
                             ...
                             <form method="POST" action="<?php echo e(route('user.change')); ?>">
                                 <?php echo csrf_field(); ?>
                                 <div class="logo-account"><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-user fa-w-14 fa-9x"><path fill="currentColor" d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm89.6 32h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 288 0 348.2 0 422.4V464c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48v-41.6c0-74.2-60.2-134.4-134.4-134.4z" class=""></path></svg></div>
                                       ...
                                       <input type="nickname" class="form-control" id="nickname" placeholder="Nickname" name="nickname" value="<?php echo e(old('nickname', auth()->user()->nickname)); ?>">
...
unset($__errorArgs, $__bag); ?> -->
                                       ...
                                       <input value="<?php echo e(old('name', auth()->user()->name)); ?>" id="name" type="text" class="form-control <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                       ...
                                       <input value="<?php echo e(old('email', auth()->user()->email)); ?>" id="email" type="email" class="form-control" name="email" required autocomplete="email">
...
unset($__errorArgs, $__bag); ?>" name="oldpassword" required>
...
unset($__errorArgs, $__bag); ?>
                                       ...
                                       <input id="password" type="password" class="form-control <?php $__errorArgs = ['clave'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="clave" required autocomplete="new-password">
...
unset($__errorArgs, $__bag); ?>
                ...
                <!--    <div id="vertgraph">-->
                <!--        <ul>-->
                <!--        <li class="critical" style="height: 150px;">22 <div class="img-grafic"><img src="<?php echo e(url('/assets/frontend/images/1.jpg')); ?>"></img></div> </li>-->
                <!--        <li class="high" style="height: 80px;">7 <div class="img-grafic"><img src="<?php echo e(url('/assets/frontend/images/2.jpg')); ?>"></img></div></li>-->
                <!--        <li class="medium" style="height: 50px;">3 <div class="img-grafic"><img src="<?php echo e(url('/assets/frontend/images/3.jpg')); ?>"></img></div></li>-->
                <!--        <li class="low" style="height: 90px;">8 <div class="img-grafic"><img src="<?php echo e(url('/assets/frontend/images/4.jpg')); ?>"></img></div></li>-->
                <!--        <li class="info" style="height: 40px;">2 <div class="img-grafic"><img src="<?php echo e(url('/assets/frontend/images/5.jpg')); ?>"></img></div></li>-->
                <!--        </ul>-->
                <!--        </div>-->
                <!--</div>-->
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\proyectofinal\resources\views/frontend/user/administration.blade.php ENDPATH**/ ?>