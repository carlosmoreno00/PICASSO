        ...
        <section class="section-gallery">
            ...
            <div class="container container-gallery" >
                <div class="row row-gallery" >
                    <div class="col-12">
                      <h1> <b>PICASSO</b>  — My Photos</h1>
                    </div>
                     <div class="col-12 col-createpreset">
                        <a href="<?php echo e(url('/myphotos/create')); ?>" class="createpreset">Add Photo</a>
                    </div>
                    <div class="col-6">
                        ...
                        <div class="gallery-feed">
                            ...
                            <div class="item">
                                <a href="<?php echo e(url('home/photos/' . $photo->id  )); ?>"><img src="data:image/png;base64,<?php echo e($photo->photo); ?>"></img> </a>
                                <div class="user-see">
                                    <h5><?php echo e(date('d-m-y', strtotime($photo->created_at))); ?></h5>
                                    <!--<a data-fancybox="gallery" href="<?php echo e(url('/assets/frontend/images/1.jpg')); ?>">-->
                   ...
                   align-items: flex-end;
                    ...
                    <div class="col-6 grafic">
                        <div><div class="content-grafic">
                            ...
                            <div id="vertgraph">
                                <ul>
                                    <?php $__currentLoopData = $photosgraphics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photosgraphic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        
                                        <li class="info" style="height: <?php echo e($photosgraphic->numbergraphic); ?>0%;max-height: 90%!important;padding-bottom: 28px!important;"><?php echo e($photosgraphic->numbergraphic); ?> <div class="img-grafic"><img src="data:image/png;base64,<?php echo e($photosgraphic->img); ?>"></img></div> </li>
...
<?php /**PATH C:\xampp\htdocs\proyectofinal\resources\views/frontend/photo/myphotos.blade.php ENDPATH**/ ?>